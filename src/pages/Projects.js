...
function Projects(props){
    ...
    return <Grid container className='App-container'  id="projects">
            ...
            framework in python and deployed the CNN model in Azure Cloud
                ...
                <Grid item xs={12} md={4} lg={4} p={2} className="content">
                    <Card sx={{ maxWidth: 500, minHeight:550 }}>
                        ...
                        <IconButton color="buttonColor" onClick={()=>openInNewTab("https://drive.google.com/file/d/1iBr5EFQnRm7ZSppvwi0ZB4nDpTv9HUql/view?usp=share_link")}><PictureAsPdfIcon sx={{ fontSize: "30px" }}/></IconButton>
            ...
            achieved a 2 percent higher accuracy than the standard model
                ...
                <Grid item xs={12} md={4} lg={4} p={2} className="content">
                    <Card sx={{ maxWidth: 500,  minHeight:550 }}>
                        ...
                        <IconButton color="buttonColor" onClick={()=>openInNewTab("https://github.com/rachanac16/OnlinePrintShop")}><GitHubIcon sx={{ fontSize: "30px" }}/></IconButton>
                        </div>
                        <br/>
                        <div className="content-small color-grey padding2">
                        JAN 2019 - JAN 2020
            ...
            startup time and make the application memory efficient by exploiting Spring boot’s bean configurations
                ...
                <Grid item container xs={12} md={12} lg={12} className="center-flex bg-primary">
                    <IconButton onClick={()=>props.scrollTo("#home")}><KeyboardDoubleArrowUpIcon color="secondary" sx={{ fontSize: "30px", "&:hover": { color: "#000000" }}}/></IconButton>
                </Grid>
            </Grid>;
}
