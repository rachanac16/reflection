...
function EducationRecord(props){
    ...
    return <Grid item container xs={12} md={6} lg={6}>
                ...
                <Grid item container direction="column" xs={3} md={3} lg={3} className="bg-primary">
                ...
                <Grid item container direction="column" xs={9} md={8} lg={8} className="padding2" spacing={2}>
