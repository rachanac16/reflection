...
const ExperienceData = [
    ...
    },
    {
        ...
        description:['Responsible for architecting and implementing cloud solutions', 'Developing software solutions around client requirements in Python and Angular.', 'Deploying and maintaining CI/CD pipelines'], 
        icon:cvs, 
